    ...
    return (
        <div className="min-h-screen bg-transparent p-4 md:p-8 font-sans transition-colors duration-300">
            <div className="max-w-3xl mx-auto space-y-6">
                ...
                <div
                    className="flex items-center gap-4 bg-gradient-to-r from-amber-500 to-orange-500 p-6 rounded-3xl shadow-lg text-white">
                ...
                <div className="space-y-4">
                            ...
                            <Card key={user.id}
                                ...
                                <CardContent className="p-4 flex items-center gap-4">
                                    ...
                                    <img
                                        ...
                                        className="w-14 h-14 rounded-2xl object-cover shadow-sm" alt="avatar"/>
                                    ...
                                    <div className="flex-1">
                                        ...
                                        <div className="flex items-center gap-3 text-xs font-bold text-slate-500 mt-1">
                                            <span className="flex items-center gap-1 text-yellow-500"><Star size={14}
                                                                                                            fill="currentColor"/> {user.rating}</span>
                    ...
                    {leaders.length === 0 &&
                        <div className="text-center p-10 text-slate-500">Поки що немає лідерів</div>}
                </div>
            </div>
        </div>
    )
